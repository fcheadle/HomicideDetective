...
namespace Engine.Entities.Factories
{
    public static class Tile
    {
        ...
        public  static BasicTerrain Carpet(Coord position) => new BasicTerrain(ColorExtensions.Half(Color.Olive), ColorExtensions.Half(Color.DarkOliveGreen), position.Y % 2 == 1 ? 16 : 17, position, true, true);
        ...
        public  static BasicTerrain HardwoodFloor(Coord position) => new BasicTerrain(ColorExtensions.Half(Color.SaddleBrown), ColorExtensions.Half(Color.Brown), position.Y % 2 == 1 ? 174 : 175, position, true, true);
        public  static BasicTerrain Tree(Coord position) => new BasicTerrain(ColorExtensions.MutateBy(Color.Brown, Color.Black), Color.Black, '0', position, false, false);
